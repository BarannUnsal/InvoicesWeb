...
using InvoicesAPI.Business.Abstraction.Storage.Azure;
...
namespace InvoicesAPI.Business.Services.Storage.Azure
{
    public class AzuraStorage : Storage, IAzureStorage
    {
        private readonly BlobServiceClient _blobServiceClient;
        BlobContainerClient _blobContainerClient;

        public AzuraStorage(IConfiguration configuration)
        {
